...
void GUI::renderAimbotWindow(bool contentOnly) noexcept
{
    ...
    ImGui::Checkbox("OldStyle Aimbot", &config->aimbot[currentWeapon].oldstyle);
    ...
    ImGui::SliderFloat("Max Innacuracy to Trigger Better Aimbot", &config->aimbot[currentWeapon].maxTriggerInaccuracy, 0.0f, 1.0f, "%.5f", 2.0f);
...
void GUI::renderAntiAimWindow(bool contentOnly) noexcept
{
    ...
    ImGui::Checkbox("SendPacket", &config->antiAim.swapPacket);
...
void GUI::renderBacktrackWindow(bool contentOnly) noexcept
{
    ...
    ImGui::Checkbox("Extended Backtrack Records for Chamns", &config->backtrack.extendedrecords);
